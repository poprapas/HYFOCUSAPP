...
export default class New extends Component {
    ...
    _fetchData(callback) {
        fetch('https://www.hatyaifocus.com/rest/api.php?action=news&cat=4&start=' + this.state.start + '&per_page=10')
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <Text style={styles.bannerfont}> - ข่าวเศรษฐกิจและการเงิน - </Text>
                    </View>
